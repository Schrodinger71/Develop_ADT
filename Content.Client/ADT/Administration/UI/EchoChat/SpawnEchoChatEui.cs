...
using Content.Client.ADT.Administration.UI.EchoChat;

namespace Content.Client.ADT.Administration.UI.EchoChat;

[UsedImplicitly]
public sealed class SpawnEchoChatEui : BaseEui
{
    [Dependency] private readonly EntityManager _entManager = default!;
    [Dependency] private readonly IOverlayManager _overlayManager = default!;

    private readonly SpawnEchoChatWindow _window;
    //private ExplosionDebugOverlay? _debugOverlay;

    public SpawnEchoChatEui()
    {
        IoCManager.InjectDependencies(this);
        _window = new SpawnEchoChatWindow(this);
