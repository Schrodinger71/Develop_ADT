...
[UsedImplicitly]
public sealed partial class SpawnEchoChatWindow : DefaultWindow
{
    ...
    private readonly SpawnEchoChatEui _eui;
    ...
    public SpawnEchoChatWindow(SpawnEchoChatEui eui)
    {
    ...
    private void SubmitButtonOnOnPressed(ButtonEventArgs args)
    {
        ...
        var explosionType = _explosionTypes[ExplosionOption.SelectedId];
        var cmd = $"echo_chat {Intensity.Value} {Slope.Value} {MaxIntensity.Value} {MapX.Value} {MapY.Value} {mapId} {explosionType}";
